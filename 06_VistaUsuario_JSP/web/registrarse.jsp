    ...
    <body>
        ...
        <form name="form1" action="usuarios.do" method="post">
            ...
            <table border="1">
                ...
                <tr><td>Edad:</td><td>
                        <input type="number" name="edad" id="edad" value="" placeholder="introduzca edad" required="required" min="12"/>  </td></tr> 
               <tr><td>Email:</td><td>
                ...
                <tr><td>Contraseña:</td><td>
                        <input type="password" name="password" id="password" value="" placeholder="introduzca password" required="required" minlength="4"/>  </td></tr> 
            </table>
